...
-- CHARACTER CONFIG
INITIAL_LEVEL_CAP = 100; -- The initial level cap for new players.  There seems to be a hardcap of 255.
MAX_LEVEL = 100; -- Level max of the server, lowers the attainable cap by disabling Limit Break quests.
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 106; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 109; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
SHOP_PRICE = 0.001; -- Multiplies prices in NPC shops.
...
SAN_FAME   = 100.000; -- Multiplies fame earned from San d'Oria quests.
BAS_FAME   = 100.000; -- Multiplies fame earned from Bastok quests.
WIN_FAME   = 100.000; -- Multiplies fame earned from Windurst quests.
NORG_FAME  = 100.000; -- Multiplies fame earned from Norg and Tenshodo quests.
JEUNO_FAME = 100.000; -- Multiplies fame earned from Jeuno quests.

FISHING_GUILD_POINTS      = 100.000; -- Multiplies guild points earned from fishermans' guild trades.
WOODWORKING_GUILD_POINTS  = 100.000; -- Multiplies guild points earned from carpenters' guild trades.
SMITHING_GUILD_POINTS     = 100.000; -- Multiplies guild points earned from blacksmiths' guild trades.
GOLDSMITHING_GUILD_POINTS = 100.000; -- Multiplies guild points earned from goldsmiths' guild trades.
CLOTHCRAFT_GUILD_POINTS   = 100.000; -- Multiplies guild points earned from weavers' guild trades.
LEATHERCRAFT_GUILD_POINTS = 100.000; -- Multiplies guild points earned from tanners' guild trades.
BONECRAFT_GUILD_POINTS    = 100.000; -- Multiplies guild points earned from boneworkers' guild trades.
ALCHEMY_GUILD_POINTS      = 100.000; -- Multiplies guild points earned from alchemists' guild trades.
...
-- Value based on seconds 60 = 1 minute
COFFER_MAX_ILLUSION_TIME = 120;  -- 2 minutes
COFFER_MIN_ILLUSION_TIME = 60;  -- 1 minute
CHEST_MAX_ILLUSION_TIME  = 120;  -- 2 minutes
