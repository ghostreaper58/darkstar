...
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 125; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 129; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
DIA_OVERWRITE = 0; --Set to 1 to allow Bio to overwrite same tier Dia.  Default is 1.
